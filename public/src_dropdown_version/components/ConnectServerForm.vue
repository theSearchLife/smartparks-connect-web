<template>
    ...
    <template #header>
      <div class="card-header">
        ...
        <span class="float_right" v-if="config.connected"><el-tag class="ml-2" type="success">Service Connected</el-tag></span>
      </div>
    </template>
...
const formServer = reactive({
    server_url: '',
    api_key:'',
    //eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJhcGlfa2V5X2lkIjoiMWVjYWZmZjctMmZmNS00ZTEwLTg1NzgtMWE1NGM1OTIwOTE3IiwiYXVkIjoiYXMiLCJpc3MiOiJhcyIsIm5iZiI6MTY3NjY0NDEwNiwic3ViIjoiYXBpX2tleSJ9.TlSF5riii3_I1rYrQdLlQ6YBSr5LRpEosI1Lav24WdY'
  })
